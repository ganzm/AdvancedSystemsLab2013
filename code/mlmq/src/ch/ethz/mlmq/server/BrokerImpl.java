...
public class BrokerImpl implements Broker {
	...
	private final Logger logger = Logger.getLogger(BrokerImpl.class.getSimpleName());
	...
	public BrokerImpl(BrokerConfiguration config) {
		this.config = config;
		this.requestQueue = new WorkerTaskQueueImpl(config.getRequestQueueSize());
	}

	public void startup() throws MlmqException {
