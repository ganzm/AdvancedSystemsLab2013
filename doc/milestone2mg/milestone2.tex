...
Row $S$ and $X$ are measurement values obtained from Milestone I. By applying \textit{Utilisation Law} \ref{eq:UtilisationLaw} row $U$ can be calculated.   
...
The last row $D$ is obtained by combining \textit{Utilisation Law} and \textit{Forced Flow Law} \ref{eq:Demand}. 
