...
\noindent As measured in the milestone I\cite{milestone1}, the mean service time of the TCP connection is 2.644ms for sending and 2.590ms for receiving messges. For this analysis, the mean of 2.617ms is assumed to simplify the analysis.\\
...
Total service time - DB service time - 4 * TCP service time. As estimated in the milestone I\cite{milestone1}, for sending the service time is 0.042ms and for receiving it is 0.043ms. For the analysis, a service time of 0.042ms is used.\\
