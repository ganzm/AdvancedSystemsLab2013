...
The analysis yielded decent results, especially for the response time. The response time can be seen in figure \ref{fig:rt-total} and the throughput can be seen in figure \ref{fig:tp-total}
...
The mean value analysis for the response time seems pretty well. However, there seems to be a additional constant  of about 10-30ms where the response time of the model doesn't match. There might be a delay center missing, or some delay center
