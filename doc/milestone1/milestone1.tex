...
In order to have the database related and system unittests working you may need to adjust database connection information located in the following file. This file is used by all Unit Tests which need client specific configuration.
