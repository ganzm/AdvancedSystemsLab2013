...
UnitTests can't show the absence of bug. Despite of having a decent test coverage we struggled at this point.  As the project moved on, more and more bugs where discovered and fixed. Each time a software bugfix was applied which potentially affect the performance of the system all our experimental results were invalidated.

An other point which should be improved for the next project is the decision making process. We delayed what exactly to measure and to analye for too long.
